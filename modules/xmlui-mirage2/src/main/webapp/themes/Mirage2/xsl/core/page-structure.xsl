...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHeader">
		...
		<div class="row">
			<div class="col-sm-12">
				<img src="{$theme-path}images/yorkspace_header_white.jpg" class="img-responsive" alt="YorkSpace" />
			</div>
		</div>
            </div>
            <div class="navbar navbar-default navbar-static-top" role="navigation">
				...
				<!-- <img src="{$theme-path}images/YorkULogo_Hor_rgb.jpg" /> --> 
			        <!-- <h3>York University's Institutional Repository</h3> -->
                        </a>
    ...
    <xsl:template name="buildFooter">
        <footer>
               <hr/>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 hidden-print">
                        <div class="hidden-print">
					<img src="{$theme-path}images/YorkULogo_Hor_rgb.jpg" height="50px"/>
					<a>
                                	<xsl:attribute name="href">
                                    		<xsl:value-of
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-4 hidden-print text-center">
			<a target="_blank" href="http://www.dspace.org/">DSpace software</a> | <a target="_blank" href="http://www.duraspace.org/">DuraSpace</a>
        		<div>copyright&#160;&#169;&#160;2002-2016&#160; </div>
		    <!-- <div>
